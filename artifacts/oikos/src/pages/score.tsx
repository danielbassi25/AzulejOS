      ...
      <div className="px-4 pt-4 pb-24" style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
        ...
        >
          ...
          >
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '8.5px', fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'hsl(220,20%,54%)', marginBottom: '10px' }}>
              Daniel
            </p>
            <p style={{
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '8px', letterSpacing: '0.10em', textTransform: 'uppercase', color: 'hsl(220,16%,64%)', marginTop: '8px' }}>
              points
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '8.5px', fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'rgba(195,182,160,0.55)', marginBottom: '10px' }}>
              Sofia
            </p>
            <p style={{
              fontFamily: "'Cormorant Garamond', Georgia, serif",
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '8px', letterSpacing: '0.10em', textTransform: 'uppercase', color: 'rgba(175,162,142,0.38)', marginTop: '8px' }}>
              points
            </p>
          </div>
        </motion.div>
        ...
        <div className="flex items-center gap-3 px-5 py-4"
          style={{
            ...
            border: '1px solid rgba(30,60,130,0.08)',
            borderRadius: '4px',
            boxShadow: '0 1px 0 rgba(255,255,255,0.90) inset, 2px 3px 10px rgba(20,40,100,0.05)',
          }}
        >
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '8.5px', fontWeight: 700, letterSpacing: '0.10em', textTransform: 'uppercase', color: 'hsl(218,55%,38%)', minWidth: 30 }}>
          ...
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '8.5px', fontWeight: 700, letterSpacing: '0.10em', textTransform: 'uppercase', color: 'hsl(38,42%,48%)', minWidth: 30, textAlign: 'right' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {mockScore.milestones.map((milestone, idx) => (
              ...
              >
                ...
                >
                  <div>
                    <p style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 500, fontSize: '1.05rem', letterSpacing: '0.01em', color: milestone.winner ? 'hsl(42,30%,93%)' : 'hsl(222,38%,18%)' }}>
                      {milestone.title}
                    </p>
                    {milestone.winner ? (
                      <p style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600, fontSize: '0.72rem', color: 'rgba(195,182,160,0.55)', marginTop: '4px' }}>
          ...
          <div style={{
            ...
            {mockScore.recentActivities.map((activity, idx) => (
              <motion.div key={activity.id}
                ...
                style={{
                  background: idx % 2 === 0 ? 'hsl(38,30%,99%)' : 'hsl(40,18%,97%)',
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.70rem', color: 'hsl(220,13%,63%)', marginTop: '2px' }}>
                    {activity.date}
                  </p>
                </div>
                <div style={{
