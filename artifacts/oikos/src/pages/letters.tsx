                  ...
                  <div className="flex items-center gap-4 relative z-10">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 style={{
                        ...
                        color: 'rgba(222,210,192,0.76)',
                      }} className="truncate">
                        {letter.title}
                      </h3>
                      <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '8.5px', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(175,190,240,0.38)', marginTop: '5px' }}>
                        Unlocks {letter.unlockDate}
                      </p>
                    </div>
                    <div style={{ fontFamily: 'Inter, sans-serif', fontSize: '7.5px', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', border: '1px solid rgba(180,200,255,0.18)', borderRadius: '2px', color: 'rgba(195,210,255,0.42)', padding: '5px 10px' }} className="shrink-0">
                      Sealed
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '8.5px', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'hsl(218,48%,42%)', marginTop: '5px' }}>
                        Opened {letter.unlockDate}
                      </p>
                    </div>
                    <div style={{ fontFamily: 'Inter, sans-serif', fontSize: '7.5px', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', background: 'hsl(218,70%,28%)', color: 'hsl(42,30%,96%)', borderRadius: '2px', padding: '5px 10px' }} className="shrink-0">
                      Open
                    </div>
                  </div>
                </motion.div>
