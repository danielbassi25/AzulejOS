...
import { getAllMemories, updateCustomMemory, deleteCustomMemory, isCustomItem } from "@/data/store";
        ...
        {!showDeleteConfirm ? (
          <motion.button
            ...
            style={{
              ...
              color: 'hsl(338,45%,38%)', borderRadius: '4px', padding: '14px 20px',
              border: '1px solid rgba(130,25,55,0.20)',
            }}
          >
          ...
          <div style={{
            background: 'hsl(338,45%,38%)', borderRadius: '4px', padding: '16px',
            border: '1px solid rgba(130,25,55,0.40)',
          }}>
            ...
            <div className="flex gap-2">
              <motion.button
                ...
                className="flex-1"
                style={{
                  fontFamily: 'Inter, sans-serif', fontSize: '9px', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase',
                  background: 'rgba(255,252,245,0.12)', color: 'hsl(42,30%,94%)',
                  border: '1px solid rgba(255,252,245,0.20)', borderRadius: '3px', padding: '10px',
                }}
              >
                Cancel
              </motion.button>
              <motion.button
                ...
                style={{
                  fontFamily: 'Inter, sans-serif', fontSize: '9px', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase',
                  background: 'rgba(255,252,245,0.90)', color: 'hsl(338,45%,32%)',
